...
- [Internationalisierung](mem://features/internationalisierung) — Translation logic, no language mixing, dynamic metadata
- [Ressourcen](mem://projekt/ressourcen) — AI-generated, royalty-free architectural placeholders
- [Rechtliches](mem://inhalt/rechtliches) — Links to official legal texts, strict disclaimer for no advice, 6 languages
- [Premium Boutique Style](mem://style/premium-boutique-konzept) — Architectural calm, module-based, no aggressive funnels
- [Bildsprache](mem://style/bildsprache-vorgaben) — Empty architecture, bright/diffuse daylight, subtle hero gold shimmer
- [Layout Konsistenz](mem://style/layout-konsistenz) — Hero heights (62svh to 70vh), 1080px global container, 4xl content
- [Animationen](mem://features/animationen) — Framer-motion subtle reveal (28px vertical offset, weighted ease)
- [Navigationslogik](mem://features/navigations-und-scroll-logik) — Animated mouse scroll indicator in hero, bottom-right fixed scroll button
- [Sektions-Beschriftung](mem://style/sektions-beschriftung) — Two-stage labels: category label above main headline
- [Platzhalter Strategie](mem://constraints/platzhalter-strategie) — Strict removal of incomplete sections instead of showing placeholders
- [Architektonisches Containment](mem://style/architektonisches-containment) — Fine left accent borders, borderless trust blocks
- [SEO Optimierung](mem://features/seo-optimierung) — JSON-LD (RealEstateAgent), no opening hours, hreflang sync
- [Hero Konfiguration](mem://features/hero-konfiguration) — Bright facade, subtle gold, no bottom fog, optimized typography
- [Kontakt Konfiguration](mem://features/kontakt-konfiguration) — 5-field form, Supabase, FAQs, high contrast, no business hours
