...
const KfwPage = () => {
  ...
  usePageSeo(pageSeo[language].taxKfw.title, pageSeo[language].taxKfw.description);
  const labels = taxExternalLinkLabels[language].kfw;
  const links = [
    { label: labels[0], url: "https://www.kfw.de" },
    { label: labels[1], url: "https://www.kfw.de/inlandsfoerderung/Privatpersonen/" },
  ];
        ...
        <div className="container max-w-4xl">
          <Reveal>
            <div className={`${panelBase} ${panelPadding}`}>
              ...
              <p className="text-muted-foreground text-[0.93rem] leading-[1.85] max-w-2xl mb-8">{t.tax.kfwIntro}</p>
