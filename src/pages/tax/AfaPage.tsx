    ...
    <Layout>
      <section className="relative py-28">
        ...
        <div className="relative container">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-primary-foreground">{t.tax.afaTitle}</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container max-w-4xl">
          <SectionHeading title={t.tax.afaSectionTitle} />
          <p className="text-muted-foreground leading-relaxed mb-12 text-lg">{t.tax.afaIntro}</p>
          <div className="space-y-10">
            {t.tax.afaSections.map((s) => (
