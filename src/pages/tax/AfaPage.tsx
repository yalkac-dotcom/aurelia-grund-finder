...
const AfaPage = () => {
  ...
  usePageSeo(pageSeo[language].taxAfa.title, pageSeo[language].taxAfa.description);
    ...
    <Layout>
      <section className="relative h-[32vh] min-h-[240px] flex items-end">
        <div className="absolute inset-0">
          <OptimizedImg src={heroSets.afa.src} srcSet={heroSets.afa.srcSet} sizes={heroSets.afa.sizes} alt={t.tax.afaTitle} className="w-full h-full object-cover" priority />
        ...
        <div className="container max-w-4xl">
          <Reveal>
            <div className={`${panelBase} ${panelPadding}`}>
              ...
              <p className="text-muted-foreground text-[0.93rem] leading-[1.85] max-w-2xl mb-8">{t.tax.afaIntro}</p>
