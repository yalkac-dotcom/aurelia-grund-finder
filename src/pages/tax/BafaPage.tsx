...
const BafaPage = () => {
  ...
  usePageSeo(pageSeo[language].taxBafa.title, pageSeo[language].taxBafa.description);
  const labels = taxExternalLinkLabels[language].bafa;
  const links = [
    { label: labels[0], url: "https://www.bafa.de" },
    { label: labels[1], url: "https://www.bafa.de/DE/Energie/Energieeffizienz/energieeffizienz_node.html" },
  ];
        ...
        <div className="container max-w-4xl">
          <Reveal>
            <div className={`${panelBase} ${panelPadding}`}>
              ...
              <p className="text-muted-foreground text-[0.93rem] leading-[1.85] max-w-2xl mb-8">{t.tax.bafaIntro}</p>
