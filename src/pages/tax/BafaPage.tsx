  ...
  return (
    <Layout>
        ...
        <div className="relative container pb-16 md:pb-24">
          <Reveal>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-white/80 font-sans text-[12px] font-medium tracking-[0.16em] uppercase">{t.tax.categoryFunding}</span>
            </div>
      ...
      <section className="py-28 md:py-36">
        <div className="container max-w-4xl">
          <Reveal>
            <p className="text-accent font-sans text-[12px] font-medium tracking-[0.16em] uppercase mb-8">{t.tax.bafaSectionTitle}</p>
          ...
          <Reveal delay={0.1}>
            <p className="text-muted-foreground text-[1.05rem] leading-[1.95] max-w-2xl mb-16">{t.tax.bafaIntro}</p>
          </Reveal>
