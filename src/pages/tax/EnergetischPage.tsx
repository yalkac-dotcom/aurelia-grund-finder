  ...
  return (
    <Layout>
      ...
      <section className="py-28 md:py-36">
        <div className="container max-w-4xl">
          <Reveal>
            <p className="text-accent font-sans text-[12px] font-medium tracking-[0.16em] uppercase mb-8">{t.tax.energetischSectionTitle}</p>
          ...
          <Reveal delay={0.1}>
            <p className="text-muted-foreground text-[1.05rem] leading-[1.95] max-w-2xl mb-16">{t.tax.energetischIntro}</p>
          </Reveal>
