  ...
  return (
    <Layout>
      <section className="relative py-28">
        ...
        <div className="relative container">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-medium uppercase tracking-widest text-accent">{t.tax.categoryTax}</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-primary-foreground">{t.tax.energetischTitle}</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container max-w-4xl">
          <SectionHeading title={t.tax.energetischSectionTitle} />
          <p className="text-muted-foreground leading-relaxed mb-12 text-lg">{t.tax.energetischIntro}</p>
          <div className="space-y-10">
            {t.tax.energetischSections.map((s) => (
