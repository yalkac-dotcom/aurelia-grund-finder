  ...
  return (
    <Layout>
      ...
      <section className="py-14 md:py-20">
        <div className="container max-w-3xl">
          <Reveal>
            <p className="text-accent font-sans text-[11px] font-medium tracking-[0.16em] uppercase mb-4">{t.tax.categoryTax}</p>
          ...
          <Reveal delay={0.1}>
            <p className="text-muted-foreground text-[0.9rem] leading-[1.85] max-w-xl mb-8">{t.tax.energetischIntro}</p>
          </Reveal>
