    ...
    <Layout>
      <section className="relative bg-[hsl(218_45%_10%)] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center pl-[3%] pr-[38%] pb-[6%]">
          <h1
            className="uppercase leading-none tracking-[0.08em] text-[clamp(1.1rem,4.6vw,4.5rem)] bg-gradient-to-b from-[hsl(42_70%_78%)] via-[hsl(40_58%_62%)] to-[hsl(36_50%_46%)] bg-clip-text text-transparent"
