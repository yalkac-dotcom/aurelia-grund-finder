...
import headerAsset from "@/assets/bildnachweise-header.png.asset.json";
  ...
  return (
    <Layout>
      <section className="relative h-[32vh] min-h-[220px] md:h-[38vh] md:min-h-[300px]">
        <img src={headerAsset.url} alt={t.footer.imageCredits} className="absolute inset-0 w-full h-full object-cover" />
