        ...
        <section className="section-premium section-navy text-white">
          <div className="container-premium">
            <Reveal>
              <div className="text-center mb-10">
                ...
                <p className="mx-auto max-w-2xl text-[0.93rem] leading-[1.85] text-white/75">
                  Wir sind Immobilien-Profis mit über 10 Jahren Erfahrung. Wir kaufen Forderungen an Immobilien, verkaufen Objekte zu fairen Preisen und ermöglichen Investoren, mit uns zu gewinnen. Unser Ziel: Menschen helfen — und dabei faire Geschäfte machen.
                </p>
              </div>
            </Reveal>
            ...
            <div className="mb-10 grid gap-6 sm:grid-cols-3">
              {[
                { value: "500+", label: "Erfolgreiche Deals", desc: "Reale Menschen, echte Ergebnisse" },
                { value: "€50M+", label: "Investitionsvolumen", desc: "Vertraut von hunderten Partnern" },
                { value: "98%", label: "Kundenzufriedenheit", desc: "Das ist unser Stolz" },
              ].map((stat, i) => (
                <Reveal key={i} delay={i * 0.08}>
                  <div className="glass-card-dark rounded-2xl p-8 text-center">
                    <p className="mb-1 text-[2rem] font-heading font-bold text-teal-400">
                      {stat.value}
                    </p>
            ...
            <Reveal delay={0.15}>
              <div className="glass-card-dark rounded-2xl p-8 md:p-10">
                ...
                <p className="mb-4 text-[0.93rem] leading-[1.85] text-white/70">
                  Transparenz. Gerechtigkeit. Erfolg. Wir verstecken uns nicht hinter Makler-Umwegen oder undurchsichtigen Prozessen. Du bekommst den echten Wert. Wir machen faire Geschäfte.
                </p>
              ...
              {[
                {
                  ...
                  desc: "Du erzählst uns Deine Situation. Wir hören zu und analysieren.",
                },
                {
                  step: "2",
                  title: "Faire Verhandlung",
                  desc: "Wir machen Dir ein ehrliches Angebot — ohne Umwege, ohne Tricks.",
                },
                {
                  step: "3",
                  title: "Schneller Abschluss",
                  desc: "Paperwork fertig, Geld auf dem Konto — in Tagen, nicht Monaten.",
                },
              ].map((item, i) => (
                <Reveal key={i} delay={i * 0.08}>
          ...
          <div className="container-premium">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                ...
                {
                  quote: "Ich habe meine Traumimmobilie unter Marktwert gekauft. Keine versteckten Kosten, keine Überraschungen.",
                  author: "Thomas M.",
                  role: "Immobilien-Käufer",
                },
                {
                  quote: "Mit Aurelia zu investieren war die beste Entscheidung. Transparente Prozesse, echte Gewinne.",
                  author: "Andreas B.",
                  role: "Investor",
                },
              ].map((story, i) => (
            ...
            <div className="mx-auto max-w-3xl text-center">
              <Reveal>
                ...
                <p className="mx-auto mb-10 max-w-lg text-[0.92rem] leading-[1.75] text-white/75">
                  Egal ob Du Hilfe brauchst, kaufen willst oder investieren möchtest — sprich mit uns. Kostenlos, unverbindlich, ehrlich.
                </p>
                <div>
                  <Link
                    to="/kontakt"
