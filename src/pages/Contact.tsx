...
const inputClasses =
  "w-full border border-border/60 bg-background px-4 py-3 text-[0.85rem] text-foreground transition-colors focus:outline-none focus:border-accent/60 placeholder:text-muted-foreground/40";
    ...
    <Layout>
      ...
      <section className="relative h-[50vh] min-h-[360px] flex items-end">
        ...
        <div className="relative container pb-16 md:pb-20">
          <Reveal>
            <p className="text-white/80 font-sans text-[11px] font-medium tracking-[0.16em] uppercase mb-4">{t.contact.title}</p>
      ...
      <section className="py-24 md:py-32">
        <div className="container max-w-3xl">
          <Reveal>
            <p className="text-muted-foreground text-[0.95rem] leading-[1.95] max-w-xl">
              {t.contact.introText}
            </p>
          </Reveal>
        </div>
      ...
      <section className="border-t border-border/60">
        <div className="container max-w-3xl">
          <div className="divide-y divide-border/60">
            <Reveal>
              <div className="grid md:grid-cols-[1fr_2fr] gap-3 md:gap-12 py-10">
                <div className="flex items-center gap-3">
                  <MapPin className="text-accent" size={15} />
                  <h3 className="text-[0.88rem] font-heading font-semibold text-foreground">{t.common.address}</h3>
                </div>
                <address className="not-italic text-muted-foreground text-[0.85rem] leading-[1.85]">
            ...
            <Reveal delay={0.05}>
              <div className="grid md:grid-cols-[1fr_2fr] gap-3 md:gap-12 py-10">
                <div className="flex items-center gap-3">
                  <Mail className="text-accent" size={15} />
                  <h3 className="text-[0.88rem] font-heading font-semibold text-foreground">{t.contact.email}</h3>
                </div>
                <a href="mailto:info@aurelia-grundbesitz.de" className="text-muted-foreground text-[0.85rem] hover:text-accent transition-colors">
            ...
            <Reveal delay={0.1}>
              <div className="grid md:grid-cols-[1fr_2fr] gap-3 md:gap-12 py-10">
                <div className="flex items-center gap-3">
                  <Phone className="text-accent" size={15} />
                  <h3 className="text-[0.88rem] font-heading font-semibold text-foreground">{t.contact.phone}</h3>
                </div>
                <p className="text-muted-foreground text-[0.85rem]">{t.contact.phonePending}</p>
              </div>
            </Reveal>
            <Reveal delay={0.15}>
              <div className="grid md:grid-cols-[1fr_2fr] gap-3 md:gap-12 py-10">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-[0.88rem] font-heading font-semibold text-foreground">{t.common.availability}</h3>
                </div>
                <div className="text-muted-foreground text-[0.85rem] space-y-1">
      ...
      <section className="py-24 md:py-32 bg-secondary/50">
        <div className="container max-w-2xl">
          <Reveal>
            <p className="text-accent font-sans text-[11px] font-medium tracking-[0.18em] uppercase mb-6">{t.contact.formLabel}</p>
            <h2 className="text-[1.5rem] md:text-[2.15rem] font-heading font-semibold text-foreground leading-[1.2] mb-14 text-balance">
              {t.contact.formTitle}
            </h2>
          </Reveal>
          ...
          {submitted ? (
            <Reveal>
              <div className="py-12 text-center">
                <CheckCircle className="text-accent mx-auto mb-5" size={28} />
                <h3 className="text-[1.1rem] font-heading font-semibold text-foreground mb-2">{t.contact.successTitle}</h3>
                <p className="text-muted-foreground text-[0.88rem] leading-[1.85] max-w-sm mx-auto">{t.contact.successText}</p>
              </div>
            </Reveal>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-muted-foreground/70 text-[10px] text-right mt-2">{t.contact.privacyNote}</p>
            </form>
          )}
        </div>
      </section>
      ...
      <section className="py-24 md:py-32">
        <div className="container max-w-3xl">
          <Reveal>
            <p className="text-accent font-sans text-[11px] font-medium tracking-[0.18em] uppercase mb-6">{t.common.address}</p>
            <h2 className="text-[1.5rem] md:text-[2.15rem] font-heading font-semibold text-foreground leading-[1.2] mb-14 text-balance">
