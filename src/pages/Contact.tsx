    ...
    <Layout>
      ...
      <section className="py-8 md:py-10">
        <div className="container max-w-3xl">
          <Reveal>
            <p className="text-muted-foreground text-[0.85rem] leading-[1.8] max-w-xl">
              {t.contact.introText}
            </p>
          </Reveal>
        </div>
      ...
      <section className="py-10 md:py-14 bg-secondary/50">
        <div className="container max-w-2xl">
          <Reveal>
            ...
            <h2 className="text-[1.2rem] md:text-[1.55rem] font-heading font-semibold text-foreground leading-[1.2] mb-5 text-balance">
              {t.contact.formTitle}
            </h2>
          </Reveal>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-muted-foreground/70 text-[9px] text-right mt-1">{t.contact.privacyNote}</p>
            </form>
          )}
        </div>
      </section>
