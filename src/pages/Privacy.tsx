          ...
          <div className="divide-y divide-border/60">
            <Reveal>
              <div className="pb-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75] whitespace-pre-line">{p.controllerText}</p>
                <p className="text-muted-foreground text-sm leading-[1.75] mt-1">{p.controllerCeo}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <div className="py-5">
                ...
                <ul className="list-disc pl-5 space-y-1 text-muted-foreground text-sm leading-[1.75]">
            ...
            <Reveal delay={0.15}>
              <div className="py-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75]">{p.serverLogsText}</p>
                <ul className="list-disc pl-5 space-y-0.5 mt-1 text-muted-foreground text-sm">
                  {p.serverLogsItems.map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
                <p className="text-muted-foreground text-sm leading-[1.75] mt-1">{p.serverLogsLegal}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="py-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75]">{p.contactFormText}</p>
                <p className="text-muted-foreground text-sm leading-[1.75] mt-1">{p.contactFormLegal}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="py-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75]">{p.retentionText}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.35}>
              <div className="py-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75]">{p.rightsIntro}</p>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-muted-foreground text-sm">
                  {p.rightsItems.map((r) => (
                    <li key={r.art}>
            ...
            <Reveal delay={0.4}>
              <div className="py-5">
                ...
                <p className="text-muted-foreground text-sm leading-[1.75] whitespace-pre-line">{p.contactPrivacyText}</p>
              </div>
            </Reveal>
