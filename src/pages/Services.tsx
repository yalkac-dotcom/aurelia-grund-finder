    ...
    <Layout>
      ...
      <section className="py-10 md:py-14">
        <div className="container max-w-3xl">
          ...
          <Reveal delay={0.2}>
            <p className="text-muted-foreground text-[0.85rem] leading-[1.8] max-w-xl mt-3">{t.services.introText}</p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-4xl mx-auto">
            ...
            <Reveal delay={0.1}>
              <div>
                ...
                <p className="text-muted-foreground text-[0.85rem] leading-[1.8]">{t.services.experienceText}</p>
