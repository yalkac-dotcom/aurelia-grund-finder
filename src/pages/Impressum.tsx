    ...
    <Layout>
      <section className={`relative h-[30vh] min-h-[220px] flex items-end ${isDe ? "bg-primary" : ""}`}>
        <div className="absolute inset-0">
          {isDe ? (
            <>
              <OptimizedImg src={impressumHero} alt={imp.title} tone="none" style={{ filter: "saturate(0.45) hue-rotate(35deg) brightness(0.72)" }} className="w-full h-full object-cover max-md:object-contain" priority />
              <div
                className="absolute inset-0"
                style={{
                  background: "linear-gradient(to top, rgba(27,42,74,0.80) 0%, rgba(27,42,74,0.70) 55%, rgba(27,42,74,0.64) 100%)",
                }}
              />
