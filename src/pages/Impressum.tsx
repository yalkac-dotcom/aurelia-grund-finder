    ...
    <Layout>
      <section className={`relative h-[30vh] min-h-[220px] flex items-end ${isDe ? "bg-primary" : ""}`}>
        <div className="absolute inset-0">
          {isDe ? (
            <>
              <OptimizedImg src={impressumHero} alt={imp.title} tone="none" style={{ filter: "saturate(0.6) hue-rotate(35deg) brightness(0.76)" }} className="w-full h-full object-cover max-md:object-contain" priority />
              <div
                className="absolute inset-0"
                style={{
                  background: "linear-gradient(to top, rgba(27,42,74,0.72) 0%, rgba(27,42,74,0.62) 55%, rgba(27,42,74,0.55) 100%)",
                }}
              />
              <div className="absolute inset-0" style={{ background: "rgba(250,233,198,0.85)", mixBlendMode: "soft-light", opacity: 0.7 }} />
              <div className="absolute inset-0" style={{ background: "rgba(250,233,198,0.9)", mixBlendMode: "overlay", opacity: 0.55 }} />
            </>
          ) : (
