...
export const pageExtras: Record<Language, PageExtras> = {
  de: {
    ...
    portfolio: {
      ...
      regionTitle: "Regionaler Fokus", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden und weitere Standorte im Rheinland mit Substanz, Nachfrage und Entwicklungspotenzial.",
  ...
  tr: {
    ...
    portfolio: {
      ...
      regionTitle: "Bölgesel odak", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden ve Ren Bölgesi'nde sağlam yapısı, talebi ve gelişim potansiyeli bulunan diğer konumlar.",
  ...
  en: {
    ...
    portfolio: {
      ...
      regionTitle: "Regional focus", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden and other locations in the Rhineland with substance, demand and development potential.", ctaTitle: "Enquire about specific properties", ctaText: "Briefly tell us what you are looking for, and we will review which properties in our current portfolio may be suitable for you.", ctaButton: "Enquire about our portfolio",
    },
  ...
  nl: {
    ...
    portfolio: {
      ...
      regionTitle: "Regionale focus", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden en andere locaties in het Rijnland met kwaliteit, vraag en ontwikkelingspotentieel.", ctaTitle: "Vraag naar concrete objecten", ctaText: "Vertel ons kort wat u zoekt; wij bekijken welke objecten uit onze actuele portefeuille bij u passen.", ctaButton: "Portefeuille aanvragen",
    },
  ...
  it: {
    ...
    portfolio: {
      ...
      regionTitle: "Focus regionale", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden e altre località della Renania con solidità, domanda e potenziale di sviluppo.", ctaTitle: "Richieda informazioni su immobili specifici", ctaText: "Ci descriva brevemente ciò che cerca: verificheremo quali immobili del nostro portafoglio attuale possono essere adatti alle sue esigenze.", ctaButton: "Richiedi il portafoglio",
    },
  ...
  es: {
    ...
    portfolio: {
      ...
      regionTitle: "Enfoque regional", regionText: "Düsseldorf, Mettmann, Neuss, Ratingen, Hilden y otras localidades de Renania con solidez, demanda y potencial de desarrollo.", ctaTitle: "Consulte inmuebles concretos", ctaText: "Descríbanos brevemente qué busca y comprobaremos qué inmuebles de nuestra cartera actual pueden ajustarse a sus necesidades.", ctaButton: "Consultar la cartera",
    },
