...
export const pageExtras: Record<Language, PageExtras> = {
  de: {
    imageCredits: {
      ...
      stockCredit: "Startseiten-Hero: Adobe Stock, Datei-Nr. 14562359, Foto: Thorsten Donig. Türkei-Hero: Adobe Stock, Datei-Nr. 201542905.",
  ...
  tr: {
    imageCredits: {
      ...
      stockCredit: "Ana sayfa hero görseli: Adobe Stock, dosya no. 14562359, fotoğraf: Thorsten Donig. Türkiye hero görseli: Adobe Stock, dosya no. 201542905.",
  ...
  nl: {
    imageCredits: { first: "Alle afbeeldingen op deze website zijn met kunstmatige intelligentie gegenereerd en rechtenvrij. Ze zijn speciaal voor Aurelia Grundbesitz GmbH gemaakt en dienen uitsluitend ter illustratie.", second: "Wij gebruiken geen afbeeldingen van derden waarvoor betaald moet worden of waarvan de licentiestatus onduidelijk is. Denkt u desondanks dat rechten van derden mogelijk zijn geraakt, neem dan onmiddellijk contact met ons op.", aiDisclosure: "Fotorealistische beeldmotieven op deze website zijn gedeeltelijk of volledig met generatieve kunstmatige intelligentie gemaakt of daarmee ingrijpend bewerkt. Ze dienen ter illustratie. Tenzij uitdrukkelijk anders vermeld, tonen deze beelden geen concrete te koop aangeboden objecten, daadwerkelijke bedrijfsruimten of echte vestigingslocaties van Aurelia Grundbesitz GmbH. Als ‘Illustratief’ aangeduide beelden tonen geen concreet object uit de portefeuille.", stockCredit: "Hero op de homepage: Adobe Stock, bestand nr. 14562359, foto: Thorsten Donig. Turkije-hero: Adobe Stock, bestand nr. 201542905.", contact: "Contact bij vragen" },
  ...
  fr: {
    imageCredits: {
      ...
      stockCredit: "Hero de la page d’accueil : Adobe Stock, fichier n° 14562359, photo : Thorsten Donig. Hero Turquie : Adobe Stock, fichier n° 201542905.",
