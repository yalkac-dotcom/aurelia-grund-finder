...
export const pageExtras: Record<Language, PageExtras> = {
  de: {
    imageCredits: {
      ...
      stockCredit: "Startseiten-Hero: Adobe Stock, Datei-Nr. 14562359, Foto: Thorsten Donig, Standardlizenz",
  ...
  tr: {
    imageCredits: {
      ...
      stockCredit: "Ana sayfa hero görseli: Adobe Stock, dosya no. 14562359, fotoğraf: Thorsten Donig, standart lisans",
  ...
  fr: {
    imageCredits: {
      ...
      stockCredit: "Hero de la page d’accueil : Adobe Stock, fichier n° 14562359, photo : Thorsten Donig, licence standard",
