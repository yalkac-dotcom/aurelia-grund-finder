...
const de: Translations = {
  ...
  landing: {
    ...
    serviceCards: [
      { title: "Ankauf & Analyse", text: "Systematische Identifikation und Prüfung von Immobilien aus Sondersituationen mit fundierter Markt- und Standortanalyse." },
      { title: "Bestand & Bewirtschaftung", text: "Langfristiger Portfolioaufbau mit professioneller Verwaltung, stabilen Mieteinnahmen und nachhaltiger Wertentwicklung." },
      { title: "Sanierung & Veräußerung", text: "Gezielte Entwicklung und hochwertige Renovierung mit klarem Konzept für eine werthaltige Veräußerung." },
    ],
    valuesLabel: "Werte",
