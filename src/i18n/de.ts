...
const de: Translations = {
  ...
  landing: {
    problemTitle: "Komplexe Objekte erfordern klare Strukturen",
    problemText: "Immobilien aus Zwangsversteigerungen, Nachlässen und Insolvenzen bieten erhebliche Chancen – aber nur mit der richtigen Analyse und Abwicklung.",
    problemPoints: [
      "Unklare Eigentumsverhältnisse und rechtliche Risiken",
      "Fehlende Bewertungsgrundlagen und Marktdaten",
      "Zeitdruck bei Entscheidungen ohne belastbare Basis",
    ],
    solutionTitle: "Unser Ansatz",
    solutionSubtitle: "Klar strukturierte Prozesse von der Identifikation bis zur Wertrealisierung.",
    solutionItems: [
      { title: "Analyse & Bewertung", text: "Systematische Prüfung jedes Objekts auf Substanz, Lage und Entwicklungspotenzial." },
      { title: "Strukturierte Abwicklung", text: "Rechtssichere Prozesse mit dokumentierter Entscheidungsgrundlage." },
      { title: "Wertentwicklung", text: "Bestandshaltung oder Sanierung – je nach Objektprofil und Marktlage." },
    ],
    trustTitle: "Verlässlichkeit durch Struktur",
    trustItems: [
      { label: "Für Kanzleien entwickelt", text: "Prozesse, die den Anforderungen professioneller Berater entsprechen." },
      { label: "Nachvollziehbar dokumentiert", text: "Jeder Schritt transparent und revisionssicher aufbereitet." },
      { label: "Strukturiert & prüfungssicher", text: "Klare Entscheidungsgrundlagen für Investoren und Partner." },
    ],
    offerTitle: "Zusammenarbeit",
    offerSubtitle: "Zwei bewährte Modelle für unterschiedliche Zielsetzungen.",
    offerModels: [
      { title: "Bestandshaltung & Vermietung", text: "Langfristiger Vermögensaufbau durch professionell bewirtschaftete Mietobjekte an wertstabilen Standorten." },
      { title: "Sanierung & Verkauf", text: "Gezielte Entwicklung und werthaltige Veräußerung mit klarem Konzept und dokumentierter Wertschöpfung." },
    ],
    ctaTitle: "Erstgespräch vereinbaren",
    ctaSubtitle: "Lernen Sie unseren Ansatz kennen – unverbindlich und vertraulich.",
    ...
    inlineCta: "Erstgespräch vereinbaren",
  },
  common: {
  ...
  about: {
    ...
    experienceP1: "Über 30 Jahre gebündelte Branchenerfahrung bilden das Fundament unserer Arbeit. Unser Team vereint Expertise aus den Bereichen Immobilienwirtschaft, Kapitalanlage, Projektentwicklung und Transaktionsberatung – mit einem klaren Fokus auf werthaltige Investments.",
    experienceP2: "Wir arbeiten mit einem belastbaren Netzwerk aus Banken, Investoren, Maklern und spezialisierten Dienstleistern. Ob klassische Wohnimmobilien, renditeorientierte Kapitalanlagen oder komplexe Transaktionen aus Zwangsversteigerungen und Sondersituationen – unser Team bringt die nötige Marktkenntnis und Verhandlungssicherheit mit.",
    experienceP3: "Jedes Projekt wird ganzheitlich gedacht: von der Akquise über die Strukturierung bis zur Umsetzung. Dabei entstehen fundierte Strategien, die sowohl wirtschaftlich überzeugen als auch langfristig Bestand haben.",
  },
  services: {
