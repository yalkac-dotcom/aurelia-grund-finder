...
const de: Translations = {
  ...
  landing: {
    ...
    serviceCards: [
      { title: "Projektentwicklung", text: "Immobilien mit Entwicklungspotenzial identifizieren, bewerten und durch gezielte Maßnahmen nachhaltig aufwerten." },
      { title: "Grundbesitzoptimierung", text: "Bestehende Portfolios wirtschaftlich und strukturell weiterentwickeln – mit Blick auf Ertrag, Substanz und langfristige Stabilität." },
      { title: "Strukturierung komplexer Situationen", text: "Ankauf und Abwicklung in anspruchsvollen Konstellationen wie Zwangsversteigerungen, Nachlassregelungen oder Insolvenzen." },
    ],
    valuesLabel: "Überzeugung",
    valuesTitle: "Wofür Aurelia steht",
    valuePoints: [
      { title: "Struktur statt Komplexität", text: "Wir schaffen Klarheit in anspruchsvollen Konstellationen – durch fundierte Analyse, transparente Prozesse und nachvollziehbare Entscheidungen." },
      { title: "Werthaltigkeit statt kurzfristiger Lösungen", text: "Unsere Strategien sind auf nachhaltige Ergebnisse ausgelegt. Substanz und Qualität stehen im Mittelpunkt jeder Entscheidung." },
      { title: "Diskretion und Verlässlichkeit", text: "Vertraulichkeit ist für uns kein Versprechen, sondern gelebte Praxis – gegenüber Partnern, Investoren und Eigentümern gleichermaßen." },
      { title: "Langfristige Perspektiven", text: "Wir denken in Jahren, nicht in Quartalen. Jedes Projekt wird mit dem Ziel entwickelt, dauerhaften Wert zu schaffen." },
    ],
    projectsLabel: "Investmentfokus",
    projectsTitle: "Standorte mit Substanz. Perspektiven mit Tiefe.",
    projectsText: "Wir investieren an wertstabilen Standorten in ganz Deutschland – mit Augenmerk auf nachhaltige Entwicklung, wirtschaftliche Resilienz und langfristiges Potenzial.",
    stats: [
