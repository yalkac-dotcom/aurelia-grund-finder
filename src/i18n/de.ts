...
const de: Translations = {
  ...
  index: {
    ...
    bullets: [
      ...
      "Über 30 Jahre gebündelte Erfahrung in Immobilien, Kapitalanlagen und Strukturierung.",
  ...
  investor: {
    ...
    heroSubtitle: "Aurelia prüft ausgewählte Immobilien aus besonderen Situationen und ist offen für Gespräche über projektbezogene oder langfristige Formen der Zusammenarbeit.",
    whyLabel: "Warum Aurelia",
    whyTitle: "Warum Aurelia?",
    whyP1: "Wir arbeiten selektiv, prüfen sorgfältig und denken langfristig. Nicht die Menge der Projekte steht im Vordergrund, sondern die Qualität der Auswahl, die Struktur der Umsetzung und die Nachvollziehbarkeit der Entscheidung.",
    whyP2: "Unsere Gespräche mit Interessenten beginnen grundsätzlich unverbindlich und ohne öffentliche Kapitalwerbung. Ob und in welcher Form eine Zusammenarbeit sinnvoll ist, wird immer im Einzelfall geprüft.",
    whyDisclaimer: "Hinweis: Diese Informationen sind allgemein gehalten und ersetzen keine individuelle Beratung.",
    cooperationLabel: "Zusammenarbeit",
    cooperationTitle: "Formen der Kooperation",
    cooperationModels: [
      { title: "Individuelle Kapitalüberlassung", text: "Je nach Projekt und Struktur können individuelle vertragliche Modelle geprüft werden." },
      { title: "Projektbezogene Kooperationen", text: "Bei ausgewählten Immobilien kann eine Zusammenarbeit auf Projektebene in Betracht kommen." },
      { title: "Langfristige Partnerschaften", text: "Auch wiederkehrende Zusammenarbeit auf Basis gemeinsamer Kriterien und klarer Abstimmung ist grundsätzlich denkbar." },
    ],
    cooperationDisclaimer: "Ob und in welcher Form eine Zusammenarbeit möglich ist, wird individuell geprüft.",
    transparencyLabel: "Transparenz und Risiken",
    transparencyTitle: "Wichtige Hinweise",
    transparencyText: "Immobiliennahe Investments sind mit Chancen und Risiken verbunden. Dazu gehören unter anderem Marktveränderungen, Verzögerungen in der Umsetzung, rechtliche oder technische Unsicherheiten sowie wirtschaftliche Abweichungen vom ursprünglichen Plan. Eine sorgfältige individuelle Prüfung bleibt daher unerlässlich.",
    formLabel: "Kontakt",
    formTitle: "Investorenanfrage",
    formSubtitle: "Gerne können Sie unverbindlich Kontakt mit uns aufnehmen, wenn Sie sich grundsätzlich für eine Zusammenarbeit interessieren.",
