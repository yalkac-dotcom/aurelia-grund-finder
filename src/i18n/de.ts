...
const de: Translations = {
  ...
  landing: {
    ...
    valuesLabel: "Werte",
    valuesTitle: "Vertrauen entsteht durch Substanz, nicht durch Versprechen.",
    valuePoints: [
      "Über 30 Jahre gebündelte Erfahrung in Immobilienwirtschaft und Kapitalanlage.",
      "Ein belastbares Netzwerk aus Banken, Investoren und spezialisierten Dienstleistern.",
      "Diskrete, strukturierte Abwicklung – von der Analyse bis zur Übergabe.",
