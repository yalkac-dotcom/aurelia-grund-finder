...
const de: Translations = {
  ...
  investors: {
    ...
    prioritiesBadge: "Investorensicht",
    prioritiesTitle: "Was Investoren typischerweise wichtig ist",
    prioritiesDesc: "Im Mittelpunkt stehen für viele Investoren drei Punkte: die Qualität der Auswahl, die Nachvollziehbarkeit der Projektstruktur und eine realistische Einschätzung wirtschaftlicher Entwicklungen. Aurelia verfolgt dabei einen Ansatz, der auf ruhiger Prüfung, klarer Kommunikation und belastbarer Strukturierung beruht.",
    prioritiesItems: [
      { title: "Auswahlqualität", desc: "Nicht die Anzahl der Projekte, sondern die Qualität der Einordnung ist entscheidend." },
      { title: "Nachvollziehbare Struktur", desc: "Projektlogik, Maßnahmen und wirtschaftliche Annahmen müssen verständlich und plausibel sein." },
      { title: "Realistische Perspektive", desc: "Im Mittelpunkt stehen belastbare Einzelfallbetrachtungen statt pauschaler Renditeversprechen." },
    ],
    ...
    caseStudy: {
      title: "Beispielprojekt: Wohnimmobilie aus besonderer Ausgangssituation",
      startLabel: "Ausgangslage",
      startText: "Erwerb einer Immobilie mit klar erkennbarem Entwicklungspotenzial in einer besonderen Ausgangssituation.",
      actionLabel: "Maßnahme",
      actionText: "Sorgfältige Prüfung, strukturierte Aufbereitung, gezielte Umsetzung der Entwicklungsmaßnahmen und sauber vorbereitete Exit-Strategie.",
      resultLabel: "Ergebnis",
      resultText: "Im dargestellten abgeschlossenen Einzelfall konnte ein Return on Investment von 14 % erzielt werden.",
      note: "Diese Angabe bezieht sich ausschließlich auf dieses abgeschlossene Einzelprojekt. Daraus ergibt sich keine Aussage oder Erwartung hinsichtlich zukünftiger Projekte oder Ergebnisse.",
    },
    disclaimerBadge: "Wichtiger Hinweis",
    disclaimerTitle: "Einzelfallbezogene Darstellung",
    disclaimerDesc: "Sämtliche Angaben auf dieser Seite dienen ausschließlich der allgemeinen Information über beispielhafte Projektlogik und abgeschlossene Einzelfälle. Sie stellen weder ein öffentliches Angebot noch eine Aufforderung zur Investition dar.",
