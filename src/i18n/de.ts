...
const de: Translations = {
  ...
  landing: {
    ...
    aboutTitle: "Substanz entsteht dort, wo Erfahrung auf Weitblick trifft.",
    aboutText: "Aurelia entwickelt Immobilien aus besonderen Situationen – Zwangsversteigerungen, Nachlässen, Insolvenzen. Inhabergeführt, mit über 30 Jahren Erfahrung und einem klaren Fokus auf langfristige Werthaltigkeit.",
    aboutText2: "",
